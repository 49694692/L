...
public class ScreenUtil {
    ...
    public static int getTitleBarHeight(Activity activity) {
        return getTopBarHeight(activity) - getStatusHeight(activity);
    }
    ...
    public static Bitmap snapShotWithoutStatusBar(Activity activity) {
        ...
        if (false) {
            ...
            try {
                fos = new FileOutputStream(new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/debug.png"));
